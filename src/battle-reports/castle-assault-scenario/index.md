...
{% gallery "castle-assault-scenario" %}
{% galleryImg "/battle-reports/castle-assault-scenario/images/FB_IMG_1773842294058.jpg", "Overhead view of the Elven castle of Limeswold with Elf spearmen and cavalry deployed in the courtyard", 600 %}
{% galleryImg "/battle-reports/castle-assault-scenario/images/FB_IMG_1773842301942.jpg", "Wide view of the battlefield showing the Tomb King undead horde advancing toward the castle gates with siege equipment", 600 %}
{% galleryImg "/battle-reports/castle-assault-scenario/images/FB_IMG_1773842306897.jpg", "Undead forces with siege towers advancing on the castle gatehouse flanked by Tomb King infantry", 600 %}
{% galleryImg "/battle-reports/castle-assault-scenario/images/FB_IMG_1773842311336.jpg", "Aerial view of the castle walls with Elven defenders holding the battlements against the undead assault and a fell beast circling", 600 %}
{% galleryImg "/battle-reports/castle-assault-scenario/images/FB_IMG_1773842353584.jpg", "Castle walls breached with Tomb King siege equipment and undead dragon closing in as the assault reaches its height", 600 %}
{% galleryImg "/battle-reports/castle-assault-scenario/images/FB_IMG_1773842359509.jpg", "Undead forces with siege tower at the castle walls while Elven spearmen man the battlements and a unit approaches below", 600 %}
{% galleryImg "/battle-reports/castle-assault-scenario/images/FB_IMG_1773842366060.jpg", "Undead forces pouring through a breach in the castle wall as Elven defenders and a lich priest on undead dragon clash in the courtyard", 600 %}
{% galleryImg "/battle-reports/castle-assault-scenario/images/FB_IMG_1773842372914.jpg", "Late battle view showing the collapsed castle walls with undead skeleton spearmen advancing through the breach toward the Elf lands", 600 %}
{% endgallery %}
