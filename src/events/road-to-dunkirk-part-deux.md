...
Defender (German)- 1000 points – Early War German

## Objective 
The British must control at least three key objectives located across the centre of the board by the end of Turn 6.

## Deployment 
Meeting engagement.

British - Begin with a preparatory bombardment on Turn 1, representing the shock of the counter-attack. British forces deploy using Fog of War rules.

Germans - Must deploy within 12 inches of the board center.

## Board Setup 

The board should feature several fields and a small village to provide cover.
